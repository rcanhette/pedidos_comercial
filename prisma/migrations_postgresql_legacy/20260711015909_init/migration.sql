-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('RECEBIDO', 'APROVADO', 'RECUSADO', 'CANCELADO');

-- CreateEnum
CREATE TYPE "PermissionEffect" AS ENUM ('ALLOW', 'DENY');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('LOGIN', 'LOGOUT', 'LOGIN_FAILED', 'USER_CREATED', 'USER_UPDATED', 'USER_DEACTIVATED', 'ORDER_CREATED', 'ORDER_UPDATED', 'ORDER_STATUS_CHANGED', 'ORDER_CANCELLED', 'AUXILIARY_CREATED', 'AUXILIARY_UPDATED');
...
CREATE TABLE "Order" (
    ...
    "dollarRate" DECIMAL(18,6),
    "paymentTerms" TEXT NOT NULL,
    "commissionUsd" DECIMAL(18,4),
