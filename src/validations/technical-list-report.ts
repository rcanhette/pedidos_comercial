...
export const technicalListReportPageSize = 20;
const sortFields = ["sapOrderNumber", "solicitationAt", "pickupForecast", "rawMaterialNameSnapshot"] as const;
...
const filtersBase = z.object({
  ...
  rawMaterialId: z.preprocess(emptyToUndefined, z.string().optional())
});

function validateRanges(data: z.infer<typeof filtersBase>, ctx: z.RefinementCtx) {
  try {
...
export const technicalListReportFiltersSchema = filtersBase.superRefine(validateRanges);
export const technicalListReportQuerySchema = filtersBase.extend({
...
export type TechnicalListReportFiltersInput = z.infer<typeof technicalListReportFiltersSchema>;
export type TechnicalListReportQueryInput = z.infer<typeof technicalListReportQuerySchema>;

export function getCreatedRange(filters: TechnicalListReportFiltersInput) {
  return {
...
export function getPickupRange(filters: TechnicalListReportFiltersInput) {
